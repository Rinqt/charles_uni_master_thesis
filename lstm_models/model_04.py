...
class LstmV4(BaseLSTM):
    def __init__(self, model_alias, train_alias, path_dictionary, training_dictionary, hyper_parameters):
        ...
        self.item2vec_vector_size = None
    ...
    def train_model(self):
        """
             ...
             Note that there must be trained Item2Vec model for this class to function. If there is no Item2Vec model un-comment the line 37
    ...
    def process_training_data(self, fold_directory):
        """
            ...
            2. Encode the Features by using Item2Vec Vectors
        ...
        # Step 3: Remove the category pages from user sequences and encode all the items as item2vec vectors.
    ...
    def add_mask_layer(self):
        ...
        :return: Masking layer for Model 4
        """
    ...
    def encode_features(self):
        """
            Method will encode the features by using their Item2Vec representation.
            1. Iterate through self.user_sequence_list.
            2. Get the item visits in the sequence (except the last item), encode it to their Item2Vec representation.

            Note that Model 4 uses Item2Vec Encoding ONLY for the features. Labels will be One-Hot-Encoded.
            Thus, leave the last items of each sequence as-is.
        ...
        self.all_features = item2vec_sequences
    ...
    def train_i2v_model(self):
        """
            ...
            1. Load the raw user sequence data.
    ...
    def prepare_evaluation(self):
        """
            ...
            2. If training data does not exist, create one:
                ...
                2.2 Remove the catalog information. (Because Model 4 is not able to handle catalog data)
